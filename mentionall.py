...
async def handler(event):
    ...
    await event.reply('__Botun Reklam Menüsü__\n**Reklam Veya İş Birliğimi Yapmak İstiyorsunuz Botun** [Sahibi](https://t.me/ondanbitmis) **İle İletişime Geçiniz**')
...
print(">> Bot çalıyor merak etme 🚀 @ondanbitmis bilgi alabilirsin <<")
